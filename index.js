...
createMenuItem("Steaks", 22, "Dinner");
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 1b: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
function createMenuItems(food, price, style){
  let menu = {
    name: food, 
    price: price, 
    category: style,
...
createMenuItems("Soup", 8.50, "Lunch");
...
reviews.push({name: "Tony", rating:"5", feedback:"Exquisite!!"});
console.log(reviews);
...
function getLastReview(review,){
  console.log(`${review[7].name} gave the restaurant a ${review[7].rating} star review, and their feedback was: ${review[7].feedback}`);
}
